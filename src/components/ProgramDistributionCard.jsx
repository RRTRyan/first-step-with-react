export default function ProgramDistributionCard() {
    ...
    return (
        <div className="flex w-full justify-around items-center gap-3 flex-wrap">
            {cardText.map((cardTextContent, index) => (
                <div key={index} className="bg-orange-100 max-w-3/13 min-w-58 rounded-3xl aspect-square p-7 gap-5 flex flex-col justify-start">
